		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<%
						Object obj = session.getAttribute("khachHang");	//Khởi tạo 1 đối tượng lấy được từ session được setAttribute bên controller DangNhap
						KhachHang kh = null;
						if(obj!=null){	//Nếu đối tượng lấy ra khác null
							kh = (KhachHang)obj;	//Ép kiểu về kiểu KhachHang
						}
						if(kh==null){	//Nếu đối tượng KhachHang null tức là chưa đăng nhập thì tạo nút đăng nhập
					%>
					<a class="btn btn-primary" style="white-space: nowrap;" href="dangnhap.jsp">Đăng nhâp</a>	
					<%} else{ %><!-- Nếu đối tượng KhachHang lấy ra không null tức là đã đăng nhập thì tạo hiển thị thông tin đăng nhập & chỗ đăng xuất -->
					<div class="row text-center" style="margin-left: 0.25em">
						<div class="row"><b><%=kh.getTenDangNhap() %></b></div>
						<div class="row"><a style="white-space: nowrap;" href="dang-xuat">Đăng xuất</a></div>
					</div>
					<%} %>
