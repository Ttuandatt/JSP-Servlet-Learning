		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<%
						Object obj = session.getAttribute("khachHang"); // Lấy đối tượng KhachHang từ session
						KhachHang kh = null;
						if (obj != null) {
							kh = (KhachHang) obj; // Ép kiểu về đối tượng KhachHang
						}
					%>
					<div class="btn-group dropstart">	<!-- có dropstart để drop sang bên trái thay vì drop xuống dưới -->
						<button type="button" class="btn btn-primary dropdown-toggle " data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<%
								if (kh != null) { // Nếu user đã đăng nhập
									out.print(kh.getTenDangNhap()); // Hiển thị tên đăng nhập
								} else {
									out.print("Tài khoản");
								}
							%>
						...
						<div class="dropdown-menu">
							<% if (kh == null) { // Nếu chưa đăng nhập %>
								<a class="dropdown-item" href="dangnhap.jsp">Đăng nhập</a> 
								<a class="dropdown-item" href="dangky.jsp">Đăng ký</a>
							<% } else { // Nếu đã đăng nhập %>
								<a class="dropdown-item" href="doimatkhau.jsp">Đổi mật khẩu</a> 
								<a class="dropdown-item" href="doithongtin.jsp">Thay đổi thông tin</a>
